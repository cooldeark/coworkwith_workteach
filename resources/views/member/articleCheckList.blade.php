  ...
  <body>
         ...
         <h1 class="mt-3">文章列表</h1>
	      ...
	      <div class="textShow">{{$value['content']}}</div>
              ...
              <td style="width:14%;">
                ...
                <div class="textShow2">{{$value['studentFeedback']}}</div>
                <button class="showContent2 ml-5 btn-primary">學生回饋</button>
                @endif
              </td>
              </tr>
              @endforeach
	...
	var getNowTime=$(this).parent().parent().find('.articleTimeModal').text();
	  ...
	  url:'/updateComments',
			  ...
			  data:{articleTeacherComment:$(this).parent().parent().find('.giveArticleContent').val(),articleTeacherScores:$(this).parent().parent().find('.giveArticleScores').val(),articleTitleFind:getNowTitle, articleTimeFind:getNowTime},
                  type:'POST',
