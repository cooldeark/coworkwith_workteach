         ...
         <h2 class="mb-3">{{$whoRegister}}註冊</h2>
            <div class="form-group-1">
               ...
               <div class="mb-3"><h5>居住地</h5></div>
                  <select id="city" name="address_main"><option value="null" selected>請選擇縣市</option><option value="0">基隆市</option><option value="1">臺北市</option><option value="2" >新北市</option><option value="3">桃園市</option><option value="4">新竹市</option><option value="5">新竹縣</option><option value="6">苗栗縣</option><option value="7">臺中市</option><option value="8">彰化縣</option><option value="9">南投縣</option><option value="10">雲林縣</option><option value="11">嘉義市</option><option value="12">嘉義縣</option><option value="13">臺南市</option><option value="14">高雄市</option><option value="15">屏東縣</option><option value="16">臺東縣</option><option value="17">花蓮縣</option><option value="18">宜蘭縣</option><option value="19">澎湖縣</option><option value="20">金門縣</option><option value="21">連江縣</option><option value="22">其他地區</option></select>                                             
            ...
            <div class="mb-3"><h2>學校合作或優惠代碼(若無，請待管理員聯繫繳費方式)</h2></div>
            <div>
      ...
      @if($whoRegister=='學生')
         ...
         $('#btnSubmit').on('click',function(){
            ...
            if($('#phone_number').val()!="" && $('#phone_number').val()!=undefined){
               var myRegexp=new RegExp("^\\d{8,11}$");
