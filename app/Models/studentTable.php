...
class studentTable extends Model
{
    ...
    protected $fillable=[
        ...
        'habit','write_position','read_position','write_frequency','write_experience','write_purpose','cooperation_school','photo_path','member_rate','lession_select','memberValidTime'
    ];
}
